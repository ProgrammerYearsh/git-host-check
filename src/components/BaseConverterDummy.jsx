...
function BaseConverterDummy() {
  return (
    <div
    id="crud-modal"
    tabIndex="-1"
    className=" overflow-y-auto w-full  justify-center items-center md:inset-0 h-[calc(100%-1rem)] max-h-full  "
  >
     {/* <!------- responsive edited here p-4 px-2 ----------> */}
    <div className="relative p-4 px-2 w-full  max-h-full ">
      {/* <!-- Modal content --> */}
      <div className="relative bg-mattBlack text-lightgrey rounded-lg shadow dark:bg-gray-700">
        {/* <!-- Modal header --> */}
        <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
          ...
          <button
            type="button"
            className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-lightgrey rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
        ...
        <form className="p-4 md:p-5 block font-open-sans ">
          <div className="grid gap-4 mb-4 grid-cols-2">
            ...
            <div className="col-span-2">
              <label
                htmlFor="name"
                className=" px-10 mb-5 text-sm font-medium  dark:text-white bg-lightgrey rounded-3xl"
              >
                Number
              </label>
              <input
            ...
            <div className="col-span-2">
              <label
                htmlFor="description"
                className=" mb-2 text-sm font-medium text-lightgrey dark:text-white bg-lightgrey rounded-3xl px-20"
              >
                Result
              </label>
              <textarea
            ...
            <div className="col-span-2 sm:col-span-1 hidden sm:block">
              <label
                className="block mb-2 text-sm font-medium text-lightgrey dark:text-white bg-lightgrey rounded-3xl sm:px-10 lg:px-20"
              >
                1
              </label>
              <select
...
export default BaseConverterDummy