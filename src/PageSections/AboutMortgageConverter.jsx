...
function AboutMortgageConverter() {
    useEffect(() => {
    ...
    <div className="pt-0 ">
        <div className="mx-auto  px-1 lg:px-12 md:px-3 sphn:px-2 max-w-6xl text-gray-500">
            ...
            <div data-animate-on-scroll className="lg:col-span-3   [&.animate]:animate-[1s_ease_0s_1_normal_forwards_slide-in-right] opacity-0 md:hidden">
                    <div className="">
                        <h2 className="text-3xl text-gray-950 dark:text-white font-semibold tracking-tighter">About Mortgage Calculator</h2>
...
export default AboutMortgageConverter