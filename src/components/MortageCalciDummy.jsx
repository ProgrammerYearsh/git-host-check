...
function MortageCalciDummy() {
  return (
    <div
    id="crud-modal"
    tabindex="-1"
    className=" overflow-y-auto overflow-x-hidden  justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full min-w-full"
  >
      ...
      <div className="relative bg-mattBlack text-leadGrey rounded-lg shadow dark:bg-gray-700">
        ...
        <form className="p-4 md:p-5 block font-open-sans">
          <div className="grid gap-4 mb-4 grid-cols-2">
            ...
            {/* Loan Term  */}
            <div className=" min-w-full col-span-2 hidden md:block">
              <label
                className=" mb-2 text-sm font-medium text-lightgrey dark:text-white bg-lightgrey rounded-3xl "
              >
                Loan Term
              ...
              <select
                id="category"
                className="bg-leadGrey border border-gray-300 text-mattBlack text-sm rounded-lg focus:ring-mattBlack focus:border-mattBlack flex w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 mt-2"
              >
             ...
             <div className="col-span-2">
              ...
              <input
                ...
                name="name"
                id="name"
                className=" text-mattBlack border border-gray-300  text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 mt-2 bg-lightgrey
                "
                placeholder=""
                required=""
              />
...
export default MortageCalciDummy