...
//     // Format the result to handle scientific notation for small or large values
//     setOutputValue(result.toLocaleString('en-US', {
...
const convertPower = () => {
    ...
    // Handle scientific notation for extremely large or small values
    let formattedResult;
...
export default PowerConverter2;
