...
function AboutBaseConverter() {
  ...
  return (
    <section>
    <div className="pt-0 ">
        <div className="mx-auto max-w-6xl text-gray-500 px-1 lg:px-12 md:px-3 sphn:px-2">
            <div className="grid gap-5 md:gap-0 md:grid-cols-2 lg:grid-cols-6 items-center lg:gap-10">
                <div data-animate-on-scroll className="lg:col-span-3  [&.animate]:animate-[1s_ease_0s_1_normal_forwards_slide-in-left] opacity-0">
                    ...
                    <div className="md:pr-2 lg:pr-0">
                        <h2 className="text-3xl text-gray-950 dark:text-white font-semibold tracking-tighter">About Base Converter</h2>
                        <p className="mt-6 text-mattBlack dark:text-gray-300 font-open-sans text-normal text-sm phn:text-base">It's tool can handle a wide range of bases, from the familiar base-10 system to more specialized ones like base-2 and even base-36, which utilizes digits 0-9 and letters A-Z. <br/>  <br/>This flexibility makes base converters invaluable for tasks like understanding different number systems used in computing, cryptography, and other fields..</p>
                    </div>
                </div>
...
export default AboutBaseConverter
